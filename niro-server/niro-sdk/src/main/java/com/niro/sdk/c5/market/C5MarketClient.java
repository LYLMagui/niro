...
public class C5MarketClient {
    ...
    public Map<String, C5BatchPriceInfo> batchGetPrice(C5BatchPriceRequest req) {
        return engine.execute(C5GameAPI.Market.BATCH_PRICE, Method.POST, req,
                new TypeReference<>() {
                });
    }
    ...
    public CompletableFuture<Map<String, C5BatchPriceInfo>> batchGetPriceAsync(C5BatchPriceRequest req) {
        return engine.executeAsync(C5GameAPI.Market.BATCH_PRICE, Method.POST, req,
                new TypeReference<>() {
                });
    }
    ...
    public C5SaleSearchResponse searchSale(C5SaleSearchRequest req) {
        return engine.execute(C5GameAPI.Market.SALE_SEARCH, Method.GET, req,
                new TypeReference<>() {
                });
    }
    ...
    public CompletableFuture<C5SaleSearchResponse> searchSaleAsync(C5SaleSearchRequest req) {
        return engine.executeAsync(C5GameAPI.Market.SALE_SEARCH, Method.GET, req,
                new TypeReference<>() {
                });
    }
    ...
    public C5ProductListResponse searchProductList(C5ProductListRequest req) {
        return engine.execute(C5GameAPI.Market.PRODUCT_LIST, Method.POST, req,
                new TypeReference<>() {
                });
    }
    ...
    public CompletableFuture<C5ProductListResponse> searchProductListAsync(C5ProductListRequest req) {
        return engine.executeAsync(C5GameAPI.Market.PRODUCT_LIST, Method.POST, req,
                new TypeReference<>() {
                });
    }
    ...
    public C5ProductListResponse productSearch(C5ProductSearchRequest req) {
        return engine.execute(C5GameAPI.Market.PRODUCT_SEARCH, Method.POST, req,
                new TypeReference<>() {
                });
    }
    ...
    public CompletableFuture<C5ProductListResponse> productSearchAsync(C5ProductSearchRequest req) {
        return engine.executeAsync(C5GameAPI.Market.PRODUCT_SEARCH, Method.POST, req,
                new TypeReference<>() {
                });
    }
    ...
    public Map<String, C5ItemStatInfo> getItemStatByHashName(C5ItemStatRequest req) {
        return engine.execute(C5GameAPI.Market.ITEM_STAT, Method.POST, req,
                new TypeReference<>() {
                });
    }
    ...
    public CompletableFuture<Map<String, C5ItemStatInfo>> getItemStatByHashNameAsync(C5ItemStatRequest req) {
        return engine.executeAsync(C5GameAPI.Market.ITEM_STAT, Method.POST, req,
                new TypeReference<>() {
                });
    }
    ...
    public Map<String, String> getItemSurvivalByHashName(C5ItemStatRequest req) {
        return engine.execute(C5GameAPI.Market.ITEM_SURVIVAL, Method.POST, req,
                new TypeReference<>() {
                });
    }
    ...
    public CompletableFuture<Map<String, String>> getItemSurvivalByHashNameAsync(C5ItemStatRequest req) {
        return engine.executeAsync(C5GameAPI.Market.ITEM_SURVIVAL, Method.POST, req,
                new TypeReference<>() {
                });
    }
}
