// 商品类型/武器类型映射
// key: internal_name, value: 中文名称
export const WeaponTypeMap: Record<string, string> = {
  // 手枪
  ...
  'weapon_knife_widowmaker': '塔隆刀',
  'weapon_knife_stiletto': '短剑',
  'weapon_knife_ursus': '熊刀',
  'weapon_knife_gypsy_jackknife': '纳瓦哈刀',
